...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      let re = ["/", "/checkout", "/not-found", "/termos-de-uso", "/politica-devolucao", "/produto"], rt = ["/config-page", "/dashboard"];
      e.s(["config", 0, { matcher: ["/((?!_next|static|favicon.ico|api).*)"] }, "middleware", 0, function(e10) {
        ...
        return !r2 || 3 !== r2.split(".").length || rt.some((e11) => t10 === e11 || t10.startsWith(e11 + "/")) && !r2.startsWith("ey") ? es.redirect(new URL("/", e10.url)) : es.next();
      }], 99446);
      let rr = { ...e.i(99446) }, rn = "/middleware", ri = rr.middleware || rr.default;
      if ("function" != typeof ri) throw new class extends Error {
        constructor(e10) {
          super(e10), this.stack = "";
        }
      }(`The Middleware file "${rn}" must export a function named \`middleware\` or a default function.`);
      let ra = (e10) => t_({ ...e10, IncrementalCache: t8, incrementalCacheHandler: null, page: rn, handler: async (...e11) => {
        try {
          return await ri(...e11);
        } catch (i2) {
      ...
      async function ro(e10, t10) {
        let r2 = await ra({ request: { url: e10.url, method: e10.method, headers: w(e10.headers), nextConfig: { basePath: "", i18n: "", trailingSlash: false, experimental: { cacheLife: { default: { stale: 300, revalidate: 900, expire: 4294967294 }, seconds: { stale: 30, revalidate: 1, expire: 60 }, minutes: { stale: 300, revalidate: 60, expire: 3600 }, hours: { stale: 300, revalidate: 3600, expire: 86400 }, days: { stale: 300, revalidate: 86400, expire: 604800 }, weeks: { stale: 300, revalidate: 604800, expire: 2592e3 }, max: { stale: 300, revalidate: 2592e3, expire: 31536e3 } }, authInterrupts: false, clientParamParsingOrigins: [] } }, page: { name: rn }, body: "GET" !== e10.method && "HEAD" !== e10.method ? e10.body ?? void 0 : void 0, waitUntil: t10.waitUntil, requestMeta: t10.requestMeta, signal: t10.signal || new AbortController().signal } });
        return null == t10.waitUntil || t10.waitUntil.call(t10, r2.waitUntil), r2.response;
      }
      e.s(["default", 0, ra, "handler", 0, ro], 42738);
    }]);
  }
});
